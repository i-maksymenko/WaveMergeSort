...
namespace WaveMergeSort.Benchmarks.SortProviders.Extensions
{
	public static class TimSortExtensions
	{
		...
		public static void TimSort<T>(this T[] arr) where T : IComparable<T>
		{
		...
		/// <typeparam name="T">The type of the elements of the array.</typeparam>
		public static void TimSort<T>(this T[] arr, IComparer<T> comparer)
		{
			TimSort(arr, 0, arr.Length - 1, comparer);
		}
		/// <summary>
		...
		/// <typeparam name="T">The type of the elements of the array.</typeparam>
		public static void TimSort<T>(this T[] arr, int left, int right) where T : IComparable<T>
		{
			TimSort(arr, left, right, Comparer<T>.Default);
		}
		...
		/// use when comparing elements.</param>
		/// <typeparam name="T">The type of the elements of the array.</typeparam>
		public static void TimSort<T>(this T[] arr, int left, int right, IComparer<T> comparer)
		{
			var timSort = new TimSort<T>();
			timSort.Sort(arr, left, right, comparer);
		}
	}
}
